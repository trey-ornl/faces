...
void Faces::share(Double6D &u, const bool compute)
{
  ...
  gpuFor({1,nm1},{1,nm1},{mx},{my},{mz},GPU_LAMBDA(const int ia, const int ib, const int jx, const int jy, const int jz) {
    ...
    if (jx == 0) xfs(ia,ib,jy,jz,0) = u(0,ia,ib,0,jy,jz);
    else if (jx == mxm1) xfs(ia,ib,jy,jz,1) = u(nm1,ia,ib,mxm1,jy,jz);

    if (ib == 1) {

      if (jz == 0) {
        u(0,ia,0,jx,jy,0) += zfr(0,ia,jx,jy,0);
        u(nm1,ia,0,jx,jy,0) += zfr(nm1,ia,jx,jy,0);
        if (jy < mym1) u(ia,0,0,jx,jy+1,0) += zfr(ia,0,jx,jy+1,0);
        else u(ia,0,0,jx,0,0) += zfr(ia,0,jx,0,0);
        u(ia,nm1,0,jx,jy,0) += zfr(ia,nm1,jx,jy,0);
      } else if (jz == mzm1) {
        u(0,ia,nm1,jx,jy,mzm1) += zfr(0,ia,jx,jy,1);
        u(nm1,ia,nm1,jx,jy,mzm1) += zfr(nm1,ia,jx,jy,1);
        if (jy < mym1) u(ia,0,nm1,jx,jy+1,mzm1) += zfr(ia,0,jx,jy+1,1);
      ...
      if (ia == 1) {
        ...
        if (jz == 0) {
          ...
          if (jy < mym1) {
            u(0,0,0,jx,jy+1,0) += zfr(0,0,jx,jy+1,0);
            u(nm1,0,0,jx,jy+1,0) += zfr(nm1,0,jx,jy+1,0);
          } else {
            u(0,0,0,jx,0,0) += zfr(0,0,jx,0,0);
            u(nm1,0,0,jx,0,0) += zfr(nm1,0,jx,0,0);
          }
          u(0,nm1,0,jx,jy,0) += zfr(0,nm1,jx,jy,0);
          u(nm1,nm1,0,jx,jy,0) += zfr(nm1,nm1,jx,jy,0);

        } else if (jz == mzm1) {

          if (jy < mym1) {
            u(0,0,nm1,jx,jy+1,mzm1) += zfr(0,0,jx,jy+1,1);
            u(nm1,0,nm1,jx,jy+1,mzm1) += zfr(nm1,0,jx,jy+1,1);
          } else {
            u(0,0,nm1,jx,0,mzm1) += zfr(0,0,jx,0,1);
            u(nm1,0,nm1,jx,0,mzm1) += zfr(nm1,0,jx,0,1);
          }
        ...
        if (jy < mym1) {
          ...
          u(0,nm1,nm1,jx,jy,jz) += u(0,0,nm1,jx,jy+1,jz);
          u(0,0,nm1,jx,jy+1,jz) = u(0,nm1,nm1,jx,jy,jz);
          u(nm1,nm1,0,jx,jy,jz) += u(nm1,0,0,jx,jy+1,jz);
          u(nm1,0,0,jx,jy+1,jz) = u(nm1,nm1,0,jx,jy,jz);
          u(nm1,nm1,nm1,jx,jy,jz) += u(nm1,0,nm1,jx,jy+1,jz);
          u(nm1,0,nm1,jx,jy+1,jz) = u(nm1,nm1,nm1,jx,jy,jz);
        }
        ...
        if (jx == 0) {
          ...
          if (jy < mym1) {
            ...
            xfs(0,0,0,jz,0) = u(0,0,0,0,0,jz);
            xfs(0,nm1,0,jz,0) = u(0,0,nm1,0,0,jz);
          }
          xfs(nm1,nm1,jy,jz,0) = u(0,nm1,nm1,0,jy,jz);
